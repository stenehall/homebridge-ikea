...
const coap = (method, config, payload) => `${config.coapClient} -u "Client_identity" -k "${config.psk}" -m ${method} ${payload} coaps://${config.ip}/15001/` 

const put = (config, id, payload) => coap("put", config, '-e \'' + payload + '\'') + id
